...
void heading1()
{
	...
	cout << endl
		 << endl
		 << setw(20) << "Name" << setw(10) << "RollNo" << setw(13) << "Semester" << setw(20) << "Department" << setw(7) << "Grade" << setw(12) << "Percentage" << setw(12) << "GPA" << setw(10) << "ObtMarks" << setw(12) << "TotalMarks" << setw(7) << "Status";
	cout << endl;
}
...
struct student
{
	...
	void showTranscript()
	{
		...
		cout << endl
			 << endl
			 << "Student Name: " << setw(22) << name << "Roll No: " << setw(20) << rollNo << endl;
		cout << "*************************************************************************************************" << endl;
		heading2();
		...
		cout << setw(12) << "ICT" << setw(13) << ict << setw(12) << Pict << setw(6) << Gict << setw(12) << GPict << setw(12) << 3 << endl
			 << endl;
		cout << "*************************************************************************************************" << endl;
	}
	...
	do
	{
		...
		case 4:
		{
			...
			case 1:
			{
				...
				{
					cout << endl
						 << "Enter Name To Display Transcript: ";
					cin.ignore();
					getline(cin, nm);
					for (int i = 0; i < n; i++)
					{
			...
			case 2:
			{
				...
				{
					cout << endl
						 << "Enter Roll No To Display Transcript: ";
					cin >> rn;
					for (int i = 0; i < n; i++)
					{
						if (rn == std[i].rollNo)
				...
				if (chkRollNo == 0)
				{
					cout << "No Such Roll No Found " << endl
						 << endl;
				}
				cout << endl
					 << endl;
		...
		case 8:
		{
			...
			{
				cout << endl
					 << "Enter Roll No To Modify Record: ";
				cin >> rn;
				for (int i = 0; i < n; i++)
				{
					if (rn == std[i].rollNo)
					{
						cout << endl
							 << endl
							 << "Following Record Will Be Modified!" << endl
							 << endl;
						std[i].showTranscript();
						cout << endl
							 << endl
			...
			if (n > 0)
			{
				...
				for (int i = 0; i < n; i++)
				{
					if (rn == std[i].rollNo)
					{
						cout << endl
							 << endl
							 << "Following Record Will Be Deleted!" << endl
							 << endl;
						std[i].showTranscript();
						chkRollNo++;
						pos = i;
